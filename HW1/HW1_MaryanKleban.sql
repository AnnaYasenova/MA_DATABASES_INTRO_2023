...
/*2. 
З таблиці Сustomer виведіть лише ім’я, прізвище та електронну пошту. В
результуючій таблиці колонки мають називатися “First Name”, “Last Name”,
“Email”
*/
select 
...
/*4.
З таблиці Film виведіть назву фільму і ціну прокату таких фільмів, ціна
...
/*8. Виведіть всю інформацію про фільми з рейтингом “G” і replacement_cost
...
/*9. 
Виведіть всю інформацію про фільми з тривалістю від 60 до 90 хвилин
включно.
*/
select * from film
where 
...
/*10. 
Виведіть всю інформацію про фільми з тривалістю меншою за 60 хвилин
або більшою за 90 хвилин
*/
select * from film
where 
	length < 60 
